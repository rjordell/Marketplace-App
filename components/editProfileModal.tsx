...
export default function EditProfileModal({
  ...
  */
  useEffect(() => {
    // Get the current session, and if the user is logged in, get the user from the database and update the user state, bio state, profilePic state, shippingAddress state, and password state.
  ...
  // Update the user in the database and update the user state with the new information.
  const onSubmit = async () => {
    ...
    .finally(() => {
      // reloads window to show updated information can comment this out without breaking anything
